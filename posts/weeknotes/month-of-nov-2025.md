...
3. Get better at talking about code and systems, as a proxy for understanding it better. I think over the next month Jalebi is going to learn so much. He can be my little [rubber ducky](https://en.wikipedia.org/wiki/Rubber_duck_debugging).
...
6. Please don't ever let me be in charge of physical things. I forgot that kolorkode was shut on Sunday and has the most stressfull three hours of my month trying to _reprint_ stickers that were already printed and just needed to be picked up in time for an event later that day.
